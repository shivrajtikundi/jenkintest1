              ...
              <Card className="main-card mb-3">
                <CardBody>
                  ...
                  <div className="text-center">
                    ...
                    <Button className="btn-wide mb-2 me-2 btn-shadow btn-gradient-primary">Wider Normal</Button>
              ...
              <Card className="main-card mb-3">
                <CardBody>
                  ...
                  <div className="text-center">
                    ...
                    <Button className="btn-wide mb-2 me-2 btn-shadow btn-gradient-primary">Normal</Button>
                    <Button className="btn-wide mb-2 me-2 btn-shadow btn-gradient-primary" size="sm">
                      Small
                    </Button>
                  </div>
