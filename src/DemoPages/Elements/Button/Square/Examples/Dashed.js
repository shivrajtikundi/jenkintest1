            ...
            <Col lg="6">
              <Card className="main-card mb-3">
                <CardBody>
                  ...
                  <Button outline className="mb-2 me-2 btn-square btn-dashed" color="secondary">
                    Secondary
                  </Button>
                  <Button outline className="mb-2 me-2 btn-square btn-dashed" color="success">
                    Success
                  </Button>
                  <Button outline className="mb-2 me-2 btn-square btn-dashed" color="info">
                    Info
                  </Button>
                  <Button outline className="mb-2 me-2 btn-square btn-dashed" color="warning">
                    Warning
                  </Button>
                  <Button outline className="mb-2 me-2 btn-square btn-dashed" color="danger">
                    Danger
                  </Button>
                  <Button outline className="mb-2 me-2 btn-square btn-dashed" color="focus">
                    Focus
                  </Button>
                  <Button outline className="mb-2 me-2 btn-square btn-dashed" color="alternate">
                    Alt
                  </Button>
                  <Button outline className="mb-2 me-2 btn-square btn-dashed" color="light">
                    Light
                  </Button>
                  <Button outline className="mb-2 me-2 btn-square btn-dashed" color="dark">
                    Dark
                  </Button>
                  <Button outline className="mb-2 me-2 btn-square btn-dashed" color="link">
                    link
                  </Button>
                </CardBody>
              </Card>
            ...
            <Col lg="6">
              <Card className="main-card mb-3">
                <CardBody>
                  ...
                  <Button outline className="mb-2 me-2 btn-square btn-dashed" active color="dark">
                    Dark
                  </Button>
                  <Button outline className="mb-2 me-2 btn-square btn-dashed" active color="link">
                    link
                  </Button>
                </CardBody>
              </Card>
            ...
            <Col lg="6">
              <Card className="main-card mb-3">
                <CardBody>
                  ...
                  <Button outline className="mb-2 me-2 btn-square btn-dashed" disabled color="link">
                    link
                  </Button>
                </CardBody>
              </Card>
