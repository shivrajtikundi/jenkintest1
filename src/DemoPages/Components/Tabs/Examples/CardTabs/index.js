                  ...
                  <Card className="main-card mb-3">
                    ...
                    <CardBody>
                      <TabContent activeTab={this.state.activeTab}>
                        ...
                        <TabPane tabId="2">
                          <p>
                            Like Aldus PageMaker including versions of Lorem. It has survived not only five centuries,
                    ...
                    <CardHeader>
                      ...
                      <div className="btn-actions-pane-right">
                        ...
                        <Button
                          ...
                          color="alternate"
                          className={
                            'btn-pill btn-wide me-1 ms-1 ' + classnames({ active: this.state.activeTab === '2' })
                          }
                          onClick={() => {
                            this.toggle('2');
                          }}
                    ...
                    <CardHeader>
                      ...
                      <div className="btn-actions-pane-right">
                        ...
                        <Button
                          outline
                          className={
                            'me-1 ms-1 border-0 btn-transition ' + classnames({ active: this.state.activeTab === '2' })
                          }
                          color="primary"
                          onClick={() => {
                            this.toggle('2');
