...
import { Row, Col, ListGroupItem, ListGroup, Button, CardTitle, Input } from 'reactstrap';
                ...
                <div className="widget-content p-0">
                  <div className="widget-content-wrapper">
                    ...
                    <div className="widget-content-left">
                      <div className="widget-heading fw-normal">TPSReport.docx</div>
                    </div>
              ...
              <ListGroupItem className="pt-2 pb-2 pe-2">
                <div className="widget-content p-0">
                  <div className="widget-content-wrapper">
                    ...
                    <div className="widget-content-left">
                      <div className="widget-heading fw-normal">Latest_photos.zip</div>
                    </div>
                    <div className="widget-content-right widget-content-actions">
                      <Button size="sm" className="btn-icon btn-icon-only" color="link">
                        <FontAwesomeIcon icon={faCloudDownloadAlt} />
              ...
              <ListGroupItem className="pt-2 pb-2 pe-2">
                <div className="widget-content p-0">
                  <div className="widget-content-wrapper">
                    ...
                    <div className="widget-content-left">
                      <div className="widget-heading fw-normal">Annual Revenue.pdf</div>
                    </div>
                    <div className="widget-content-right widget-content-actions">
                      <Button size="sm" className="btn-icon btn-icon-only" color="link">
                        <FontAwesomeIcon icon={faCloudDownloadAlt} />
              ...
              <ListGroupItem className="pt-2 pb-2 pe-2">
                <div className="widget-content p-0">
                  <div className="widget-content-wrapper">
                    ...
                    <div className="widget-content-left">
                      <div className="widget-heading fw-normal">Analytics_GrowthReport.xls</div>
                    </div>
                    <div className="widget-content-right widget-content-actions">
                      <Button size="sm" className="btn-icon btn-icon-only" color="link">
                        <FontAwesomeIcon icon={faCloudDownloadAlt} />
              ...
              <ListGroupItem>
                ...
                <div className="widget-content p-0">
                  <div className="widget-content-wrapper">
                    ...
                    <div className="widget-content-left">
                      <div className="widget-heading">Build more components</div>
                    </div>
                  </div>
                </div>
              </ListGroupItem>
