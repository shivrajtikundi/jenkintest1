...
import { ResponsiveContainer, AreaChart, Tooltip, LineChart, Line, BarChart, Bar, Area } from 'recharts';
        ...
        <Container fluid>
          <Row>
            ...
            <Col md="12" lg="6" xl="5">
              <Card className="main-card mb-3">
                <CardBody>
                  <h6 className="text-muted text-uppercase font-size-md opacity-7 mb-3 fw-normal">Highlights</h6>
                          ...
                          <div className="widget-content p-0">
                            <div className="widget-content-wrapper">
                              ...
                              <div className="widget-content-left">
                                <div className="widget-heading">Beck Collier</div>
                                <div className="widget-subheading mt-1 opacity-10">
                                  <div className="badge rounded-pill bg-primary">$152</div>
                                </div>
                              </div>
                        ...
                        <ListGroupItem>
                          <div className="widget-content p-0">
                            <div className="widget-content-wrapper">
                              ...
                              <div className="widget-content-left">
                                <div className="widget-heading">Angelo Hume</div>
                                <div className="widget-subheading mt-1 opacity-10">
                                  <div className="badge rounded-pill bg-primary">$53</div>
                                </div>
                              </div>
                              <div className="widget-content-right">
                                <div className="fsize-2 text-success">
                        ...
                        <ListGroupItem>
                          <div className="widget-content p-0">
                            <div className="widget-content-wrapper">
                              ...
                              <div className="widget-content-left">
                                <div className="widget-heading">Saim Melendez</div>
                                <div className="widget-subheading mt-1 opacity-10">
                                  <div className="badge rounded-pill bg-primary">$239</div>
                                </div>
                              </div>
                              <div className="widget-content-right">
                                <div className="fsize-2 text-success">
                        ...
                        <ListGroupItem>
                          <div className="widget-content p-0">
                            <div className="widget-content-wrapper">
                              ...
                              <div className="widget-content-left">
                                <div className="widget-heading">Primrose Navarro</div>
                                <div className="widget-subheading mt-1 opacity-10">
                                  <div className="badge rounded-pill bg-primary">$21</div>
                                </div>
                              </div>
                              <div className="widget-content-right">
                                <div className="fsize-2 text-success">
                        ...
                        <ListGroupItem>
                          <div className="widget-content p-0">
                            <div className="widget-content-wrapper">
                              ...
                              <div className="widget-content-left">
                                <div className="widget-heading">Finnlay Barton</div>
                                <div className="widget-subheading mt-1 opacity-10">
                                  <div className="badge rounded-pill bg-primary">$381</div>
                                </div>
                              </div>
                              <div className="widget-content-right">
                                <div className="fsize-2 text-success">
                        ...
                        <ListGroupItem>
                          <div className="widget-content p-0">
                            <div className="widget-content-wrapper">
                              ...
                              <div className="widget-content-left">
                                <div className="widget-heading">Johan Corbett</div>
                                <div className="widget-subheading mt-1 opacity-10">
                                  <div className="badge rounded-pill bg-primary">$74</div>
                                </div>
                              </div>
                              <div className="widget-content-right">
                                <div className="fsize-2 text-success">
                          ...
                          <div className="widget-content p-0">
                            <div className="widget-content-wrapper">
                              ...
                              <div className="widget-content-left">
                                ...
                                <div className="widget-subheading mt-1 opacity-10">
                                  <div className="badge rounded-pill bg-primary">$7</div>
                                </div>
                              </div>
                              <div className="widget-content-right">
                                <div className="fsize-2 text-success">
              ...
              <tbody>
                <tr>
                  ...
                  <td className="text-center">
                    <div className="badge rounded-pill ps-2 pe-2 bg-warning">Pending</div>
                  </td>
                  <td>
                    <div className="widget-content p-0">
                      <div className="widget-content-wrapper">
                ...
                <tr>
                  ...
                  <td className="text-center">
                    <div className="badge rounded-pill ps-2 pe-2 bg-success">Completed</div>
                  </td>
                  <td>
                    <div className="widget-content p-0">
                      <div className="widget-content-wrapper">
                ...
                <tr>
                  ...
                  <td className="text-center">
                    <div className="badge rounded-pill ps-2 pe-2 bg-danger">In Progress</div>
                  </td>
                  <td>
                    <div className="widget-content p-0">
                      <div className="widget-content-wrapper">
                ...
                <tr>
                  ...
                  <td className="text-center">
                    <div className="badge rounded-pill ps-2 pe-2 bg-info">On Hold</div>
                  </td>
                  <td>
                    <div className="widget-content p-0">
                      <div className="widget-content-wrapper">
              ...
              <Card className="card-shadow-primary card-border mb-3">
                <div className="dropdown-menu-header">
                  <div className="dropdown-menu-header-inner bg-primary">
                    ...
                    />
                    <div className="menu-header-content">
                      <h5 className="menu-header-title text-capitalize mb-0 fsize-3">Top Sellers</h5>
                      <h6 className="menu-header-subtitle mb-3">Yet another Example of Card Boxes</h6>
                      <ButtonGroup className="mb-0">
                        <Button
                          color="warning"
                          className={'btn-pill ps-3 pe-3 ' + classnames({ active: this.state.activeTab === '1' })}
                        >
                          John
                        </Button>
                        <Button
                          color="warning"
                          className={'ps-3 pe-3 ' + classnames({ active: this.state.activeTab === '2' })}
                        >
                          Mary
                        </Button>
                        <Button
                          color="warning"
                          className={'btn-pill ps-3 pe-3 ' + classnames({ active: this.state.activeTab === '3' })}
                        >
                          Katie
                        </Button>
                      </ButtonGroup>
                      ...
                      <Col md="6">
                        ...
                        <div className="widget-chart">
                          <div className="widget-chart-content">
                            ...
                            <div className="widget-subheading">Sales this Month</div>
                          </div>
                        </div>
                      </Col>
                    </Row>
                        ...
                        <Col sm="12">
                          <div className="p-1">
                            <Button
                              ...
                              color="warning"
                            >
                              <span className="text-uppercase fw-bold">Refresh Liquid Gauge</span>
                            </Button>
                          </div>
                        </Col>
                      </Row>
