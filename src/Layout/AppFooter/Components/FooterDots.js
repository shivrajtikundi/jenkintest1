                ...
                <div>
                  <div className="card no-shadow widget-chart widget-chart2 text-start p-0 m-1">
                    <div className="widget-chat-wrapper-outer">
                      <div className="widget-chart-content ps-3 pt-2 pe-2 mb--2">
                        <div className="widget-chart-flex">
                          <div className="widget-title opacity-6 text-muted text-uppercase">Helpdesk Tickets</div>
                        </div>
                        <div className="widget-numbers">
                          <div className="widget-chart-flex">
                            <div>
                ...
                <div>
                  <div className="card no-shadow widget-chart widget-chart2 text-start p-0 m-1">
                    <div className="widget-chat-wrapper-outer">
                      <div className="widget-chart-content ps-3 pt-2 pe-2 mb--2">
                        <div className="widget-chart-flex">
                          <div className="widget-title opacity-6 text-muted text-uppercase">Last Year Total Sales</div>
                        </div>
                        <div className="widget-numbers">
                          <div className="widget-chart-flex">
                            <div>
