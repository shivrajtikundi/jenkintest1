...
const Profile = () => {
  const [{ user_name, user_email, user_pass, edit_btn_text, inf_read_only, modalOpen }, setState] = React.useState({
  ...
  return (
    <Fragment>
      <Row>
        ...
        <Col md="12">
          <Card>
            <CardHeader className={style.customCardHeader}>Account Details</CardHeader>
      ...
      <Modal isOpen={modalOpen}>
        ...
        <ModalBody className={style.customModalBody}>
          <FormGroup>
            <Label className={style.customLabel} for="pass">
              Enter Your Current Password
            </Label>
            <Input
              className={style.customConfirmPassInput}
              type="password"
              name="pass"
              id="pass"
          ...
          <FormGroup>
            <Label className={style.customLabel} for="c_pass">
        ...
        <ModalFooter className={style.customModalFooter}>
          <Row style={{ display: 'block', paddingLeft: '15px', paddingRight: '15px' }}>
            <Button className={style.savePassBtn} onClick={(e) => toggleModal()}>
              Save Password
            </Button>
            <Button className={style.cancelPassBtn} color="secondary" onClick={(e) => toggleModal()}>
              Cancel
            </Button>
          </Row>
        </ModalFooter>
