...
import { faAngleDown, faCalendarAlt, faEllipsisH, faCheck, faTrashAlt } from '@fortawesome/free-solid-svg-icons';
            ...
            <Col sm="12" md="6" xl="4">
              <div className="card mb-3 widget-chart">
                <div className="widget-chart-content">
                  ...
                  <div className="widget-subheading fsize-1 pt-2 opacity-10 text-warning fw-bold">Cash Deposits</div>
            ...
            <Col sm="12" md="12" xl="4">
              <div className="card mb-3 widget-chart">
                <div className="widget-chart-content">
                  ...
                  <div className="widget-subheading fsize-1 pt-2 opacity-10 text-info fw-bold">Withdrawals</div>
                  <div className="widget-description opacity-8">
                    Down by
          ...
          <Row>
            ...
            <Col sm="12" md="7" xl="8">
              <Card className="mb-3">
                ...
                <CardBody>
                  <DataTable data={data} columns={columns} pagination fixedHeader fixedHeaderScrollHeight="360px" />
                </CardBody>
              </Card>
            </Col>
          </Row>
                        ...
                        <div className="widget-content p-0">
                          <div className="widget-content-outer">
                            <div className="widget-content-wrapper">
                              ...
                              <div className="widget-content-right">
                                <div className="widget-numbers text-primary">1896</div>
                              </div>
                            </div>
                        ...
                        <div className="widget-content p-0">
                          <div className="widget-content-outer">
                            <div className="widget-content-wrapper">
                              ...
                              <div className="widget-content-right">
                                <div className="widget-numbers text-success">45,5%</div>
                              </div>
                            </div>
                            <div className="widget-progress-wrapper">
                              <Progress
                          ...
                          <div className="widget-content-outer">
                            <div className="widget-content-wrapper">
                              <div className="widget-content-left">
                                ...
                                <div className="widget-subheading">Total Profit</div>
                              </div>
                              <div className="widget-content-right">
                                <div className="widget-numbers text-danger">
                                  <small>$</small>
                        ...
                        <div className="widget-content p-0">
                          <div className="widget-content-outer">
                            <div className="widget-content-wrapper">
                              ...
                              <div className="widget-content-right">
                                <div className="widget-numbers text-focus">682</div>
                              </div>
                            </div>
                            <div className="widget-progress-wrapper">
                              <Progress
