            ...
            <Col lg="6">
              <Card className="main-card mb-3">
                <CardBody>
                  ...
                  <Button outline className="mb-2 me-2 btn-outline-2x btn-pill" color="primary">
                    Primary
                  </Button>
                  <Button outline className="mb-2 me-2 btn-outline-2x btn-pill" color="secondary">
                    Secondary
                  </Button>
                  <Button outline className="mb-2 me-2 btn-outline-2x btn-pill" color="success">
                    Success
                  </Button>
                  <Button outline className="mb-2 me-2 btn-outline-2x btn-pill" color="info">
                    Info
                  </Button>
                  <Button outline className="mb-2 me-2 btn-outline-2x btn-pill" color="warning">
                    Warning
                  </Button>
                  <Button outline className="mb-2 me-2 btn-outline-2x btn-pill" color="danger">
                    Danger
                  </Button>
                  <Button outline className="mb-2 me-2 btn-outline-2x btn-pill" color="focus">
                    Focus
                  </Button>
                  <Button outline className="mb-2 me-2 btn-outline-2x btn-pill" color="alternate">
                    Alt
                  </Button>
                  <Button outline className="mb-2 me-2 btn-outline-2x btn-pill" color="light">
                    Light
                  </Button>
                  <Button outline className="mb-2 me-2 btn-outline-2x btn-pill" color="dark">
                    Dark
                  </Button>
                  <Button outline className="mb-2 me-2 btn-outline-2x btn-pill" color="link">
                    link
                  </Button>
                </CardBody>
              </Card>
            ...
            <Col lg="6">
              <Card className="main-card mb-3">
                <CardBody>
                  ...
                  <Button outline className="mb-2 me-2 btn-outline-2x btn-pill" active color="link">
                    link
                  </Button>
                </CardBody>
              </Card>
